...
export function StatsPage() {
  ...
  return (
    <div className="stats-section flex flex-col justify-center">
      <h3 className="text-2xl font-bold tracking-tighter sm:text-2xl xl:text-3xl/none text-[#000080]">
        Your Insights
      </h3>
      <Stats />
      <div className="flex justify-center period-control">
        <button className="btn btn-primary" onClick={() => document.getElementById('share_data_modal').showModal()}>
          Share your data
        </button>
      </div>
      <ShareDataDialog
