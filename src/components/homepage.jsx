...
* @see https://v0.dev/t/SJ7q7Y9Oph3
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-[#E6E6FA]">
          <div className="container px-4 md:px-6">
            <div
              ...
              <div className="space-y-2">
                <div
                  className="inline-block rounded-lg bg-[#FFFFFF] px-3 py-1 text-sm text-[#333333]">
                  Data Privacy
                </div>
                <h2
                  className="text-3xl font-bold tracking-tighter sm:text-5xl text-[#000080]">
