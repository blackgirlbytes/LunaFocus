      ...
      <main>
        <section className="py-12 px-4 md:px-8 lg:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="video-container">
                <iframe
                    width="560"
                    height="315"
                    src="https://www.youtube.com/watch?v=KgZYtsj9-V0"
          ...
          <p className="text-lg mb-8">
            ...
            <div className="video-container">
                <iframe
                    width="560"
                    height="315"
                    src="https://www.youtube.com/watch?v=k9CL1ETxCkU"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                ></iframe>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8714275/#ocab182-B12" style={{ color: '#000080', textDecoration: 'underline' }}>
            ...
            <ul style={{ listStyleType: 'disc', paddingLeft: '50px' }}>
              <li> <a href="https://www.businessinsider.com/mozilla-period-pregnancy-apps-privacy-warning-label-flo-glow-ovia-2022-8" style={{ color: '#000080', textDecoration: 'underline' }}>
              https://www.businessinsider.com/mozilla-period-pregnancy-apps-privacy-warning-label-flo-glow-ovia-2022-8
              </a></li>
              <li> <a href="https://www.npr.org/2022/05/10/1097482967/roe-v-wade-supreme-court-abortion-period-apps" style={{ color: '#000080', textDecoration: 'underline' }}>
              https://www.npr.org/2022/05/10/1097482967/roe-v-wade-supreme-court-abortion-period-apps
              </a></li>
              <li> <a href="https://www.ftc.gov/system/files/ftc_gov/pdf/10-Laabadli-Understanding-Womens-Privacy-Concerns-Toward-Period-Tracking-Apps-in-the-Post-Roe-v-Wade-Era.pdf" style={{ color: '#000080', textDecoration: 'underline' }}>
              ...
              <li> <a href="https://www.marketplace.org/shows/marketplace-tech/how-data-generated-by-everyday-apps-can-incriminate-abortion-seekers/" style={{ color: '#000080', textDecoration: 'underline' }}>
              https://www.marketplace.org/shows/marketplace-tech/how-data-generated-by-everyday-apps-can-incriminate-abortion-seekers/
              </a></li>
              <li> <a href="https://time.com/6298166/nebraska-abortion-pill-case-legal-experts/" style={{ color: '#000080', textDecoration: 'underline' }}>
            ...
            <ul style={{ listStyleType: 'disc', paddingLeft: '50px' }}>
            <li> <a href="https://mashable.com/article/miscarriage-stillbirth-pregnancy-apps" style={{ color: '#000080', textDecoration: 'underline' }}>
            https://mashable.com/article/miscarriage-stillbirth-pregnancy-apps
              </a></li>
              <li> <a href="https://www.washingtonpost.com/lifestyle/2018/12/12/dear-tech-companies-i-dont-want-see-pregnancy-ads-after-my-child-was-stillborn/?noredirect=on" style={{ color: '#000080', textDecoration: 'underline' }}>
